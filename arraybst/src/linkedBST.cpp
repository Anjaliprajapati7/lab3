...
void linkedBST::add(int key, int data)
{
...
void linkedBST::add(Node *subroot, Node *newNode)
{
    
    if (subroot->key > newNode->key) {
        if (subroot->left != nullptr) {
            add(subroot->left, newNode);
        }
        else {
...
void linkedBST::remove(int deleteKey){
